...
const (
	...
	// AgentNotReadyNodeTaint is removed from nodes' taints which prevents pods
	// from being scheduled until Cilium is setup. Mostly used in cloud
	// providers to prevent existing CNI plugins from managing pods.
